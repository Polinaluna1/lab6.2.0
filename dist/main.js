...
function initApp() {
    ...
    function applyTheme() {
        if (!themeStyle)
            return;
        themeStyle.setAttribute("href", state.theme === "light" ? "css/style1.css" : "css/style.css");
    ...
    function renderProjects() {
        ...
        const filtered = projects.filter(p => p.title.toLowerCase().includes(state.searchQuery.toLowerCase()));
    ...
    function updateGreetingOnInput() {
